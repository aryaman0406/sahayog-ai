export const bn = {
  ...
  chatPlaceholder: "প্রয়োজনীয় কাগজপত্র, সুবিধা বা আবেদন প্রক্রিয়া সম্পর্কে জিজ্ঞাসা করুন...",
  chatSend: "পাঠান",
  chatListening: "শুনছি...",
  chatMicBtn: "কথা বলার জন্য টিপে ধরে রাখুন",
  chatMicStop: "মাইক বন্ধ করুন",
  chatConnecting: "চ্যাট সার্ভারে সংযুক্ত হরছে...",
  chatAskAny: "আপনার পছন্দের ভাষায় প্রশ্ন করুন।",
  chatDisconnected: "চ্যাট সার্ভার সংযোগ বিচ্ছিন্ন। পুনরায় সংযুক্ত হচ্ছে...",
  pdfGenerating: "নির্দেশিকা তৈরি হচ্ছে...",
  ...
  analyticsEmpty: "আপনার বিশ্লেষণ দেখতে ড্যাশবোর্ডে আপনার প্রোফাইল সম্পন্ন করুন।",
  catAgriculture: "কৃষি 🌾",
  ...
  catBusiness: "ব্যবসা ও উদ্যোক্তা 🏢",
  catBanking: "ব্যাঙ্কিং ও আর্থিক পরিষেবা 🏦",
  catWomenChild: "নারী ও শিশু উন্নয়ন 👩‍👧",
  catUtility: "উপযোগিতা ও স্যানিটেশন 🧹",
  catTransport: "পরিবহন ও পরিকাঠামো 🚜",
  catTravel: "ভ্রমণ ও পর্যটন 🧳",
  catSports: "ক্রীড়া ও সংস্কৃতি 🏆",
  ...
  // Floating Chatbot
  chatFloatingBtn: "সহযোগ AI জিজ্ঞাসা করুন",
